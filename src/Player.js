    ...
    <div className="flex items-center h-[90px] w-full bg-[#181818] px-[16px] gap-x-[16px]">
      ...
      <div className="flex items-center flex-[3]">
        ...
        <div className="mx-[14px] font-bold pr-[6px]">
          <p className="font-sm text-white">{nowPlaying.title}</p>
          <p className="font-xs text-[#b3b3b3]">{nowPlaying.author}</p>
        </div>
      ...
      <div className="flex items-center flex-col justify-center flex-[4]">
        <div className="flex items-center justify-center gap-x-[16px] mb-[6px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#fff" class="bi bi-shuffle" viewBox="0 0 16 16">
          ...
          <div className="flex items-center justify-center h-[32px] w-[32px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-skip-start" viewBox="0 0 16 16">
          ...
          <div className="flex items-center justify-center h-[32px] w-[32px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#fff" class="bi bi-play-circle-fill" viewBox="0 0 16 16">
              <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814l-3.5-2.5z" />
            </svg>
          </div>
          <div className="flex items-center justify-center h-[32px] w-[32px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-skip-end" viewBox="0 0 16 16">
          ...
          <div className="flex items-center justify-center h-[32px] w-[32px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#fff" class="bi bi-repeat" viewBox="0 0 16 16">
        ...
        <div className="flex items-center justify-center h-[12px] w-full gap-x-[8px]">
          ...
          <div className="relative h-[4px] w-[80%] bg-[hsla(0,0%,100%,.3)]">
            <div className="absolute h-full w-[30%] bg-[#1db954]"></div>
            <div className="absolute h-[12px] w-[12px] left-[calc(30%-6px)] top-[-5px] bg-[#fff] rounded-full"></div>
          </div>
      ...
      <div className="flex items-center justify-end flex-[3]">
        <div className="flex items-center justify-center h-[32px] w-[32px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#b3b3b3" class="bi bi-mic" viewBox="0 0 16 16">
            <path d="M3.5 6.5A.5.5 0 0 1 4 7v1a4 4 0 0 0 8 0V7a.5.5 0 0 1 1 0v1a5 5 0 0 1-4.5 4.975V15h3a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1h3v-2.025A5 5 0 0 1 3 8V7a.5.5 0 0 1 .5-.5z" />
            <path d="M10 8a2 2 0 1 1-4 0V3a2 2 0 1 1 4 0v5zM8 0a3 3 0 0 0-3 3v5a3 3 0 0 0 6 0V3a3 3 0 0 0-3-3z" />
          </svg>
        </div>
        <div className="flex items-center justify-center h-[32px] w-[32px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#b3b3b3" class="bi bi-list-ul" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
          </svg>
        </div>
        <div className="flex items-center justify-center h-[32px] w-[32px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#b3b3b3" class="bi bi-pc-display" viewBox="0 0 16 16">
        ...
        <div className="flex items-center justify-center h-[32px] w-[125px] ml-[8px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#b3b3b3" class="bi bi-volume-up" viewBox="0 0 16 16">
          ...
          <div className="relative h-[4px] w-[100%] bg-[hsla(0,0%,100%,.3)] ml-[4px]">
            <div className="absolute h-full w-[30%] bg-[#1db954]"></div>
            <div className="absolute h-[12px] w-[12px] left-[calc(30%-6px)] top-[-5px] bg-[#fff] rounded-full"></div>
          </div>
        </div>
